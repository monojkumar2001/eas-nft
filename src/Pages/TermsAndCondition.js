...
const TermsAndCondition = () => {
  return (
    <>
          ...
          <EasBanner title="Terms and Conditions" />
       ...
       <div class="container">
        <div class="privacy-policy-container">
            ...
            <p>
                These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Accurent LLC, doing business as Ethereum Address Service (“Ethereum Address Service,” “we,” “us,” or “our”), concerning your access to and use of the <span> <a href="/">https://easnft.com </a></span> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
            </p>
            <p>
            ...
            <h3>10. THIRD-PARTY WEBSITE AND CONTENT</h3>
            <p>
            ...
            <h3>25. CONTACT US</h3>
            <p>
                In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us at: team@easnft.com.
            </p>
        </div>
    </div>
    </main>
